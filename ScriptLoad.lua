...
if not isSupport then
    loadstring(game:HttpGet('https://raw.githubusercontent.com/Liandersson/MeuHoHoPrivado/main/ScriptLoad.lua'))()
    wait(9e9)
end

-- Carregar o script diretamente sem sistema de chaves
