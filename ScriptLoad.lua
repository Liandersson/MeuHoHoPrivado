...
if not isSupport then
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Liandersson/MeuHoHoPrivado/main/ScriptLoadButOlder.lua'))()
	return
end

-- Sistema simplificado sem verificação de chaves
local function loadScript()
	-- Simula uma chave válida para compatibilidade
	local fakeKey = "NO_KEY_REQUIRED"
	script_key = fakeKey
	getfenv(0).script_key = fakeKey
	getfenv(1).script_key = fakeKey
	getgenv().script_key = fakeKey
	
	-- Carrega o script principal diretamente
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Liandersson/MeuHoHoPrivado/main/ScriptMain.lua'))()
	
	-- Notificação de sucesso
	StarterGui:SetCore("SendNotification",{
		Title = "HoHo Hub Privado",
